let fieldsAndPaths = {
    ...
    feats: {
        ...
        exterior: {
            ...
            memoryMirrors: ["#classifiedProperties", "text=Aynalar (Hafızalı)", "$0.classList.contains('selected')", "bool"],
            sunroof: ["#classifiedProperties", "text=Sunroof", "$0.classList.contains('selected')", "bool"],
            adaptiveHeadlights: ["#classifiedProperties", "text=Far (Adaptif)", "$0.classList.contains('selected')", "bool"],
            rearParkingSensors: ["#classifiedProperties", "text=Park Sensörü (Arka)", "$0.classList.contains('selected')", "bool"],
            smartTrunk: ["#classifiedProperties", "text=Akıllı Bagaj Kapağı", "$0.classList.contains('selected')", "bool"],
            electricMirrors: ["#classifiedProperties", "text=Aynalar (Elektrikli)", "$0.classList.contains('selected')", "bool"],
